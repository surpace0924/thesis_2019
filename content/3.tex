\chapter{RADAR}
　この章ではRADARの基本原理，研究に使用するRADARの性能，LiDARとの比較を行う．
...
　RADARは照度の変化に対してロバストであると述べた．ここではRADARとLiDARの環境依存性について検証を行う．
...
　この後の考察を行いやすくするため，図\ref{fig:comparison_raw}のデータに対して移動平均フィルタを施した．フィルタ処理後のデータを図\ref{fig:comparison_filtered60}に示す．
\begin{figure}[H]
    \centering
